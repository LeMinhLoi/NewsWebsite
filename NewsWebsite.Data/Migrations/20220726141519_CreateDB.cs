...
namespace NewsWebsite.Data.Migrations
{
    public partial class CreateDB : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "ImageUsers",
                columns: new[] { "IdImage", "Path", "Tittle" },
                values: new object[] { new Guid("0619e3c9-a3ba-46ca-ba72-1136c388d003"), "themes/images/images_user/leminhloi.png", "This is tittle" });

            migrationBuilder.InsertData(
                table: "Newss",
                columns: new[] { "IdNews", "Content", "DateCreate", "IdAuthor", "IsAccept", "Tittle", "ViewCount" },
                values: new object[] { new Guid("6d26e9ea-3b32-44be-ac21-090c06bbf14e"), "<p><b>Hi! Đây là một bài báo viết về thể thao.</b></p><p><u>Chị bảy đang chuồn khỏi MU</u></p>", new DateTime(2022, 10, 10, 2, 3, 4, 0, DateTimeKind.Unspecified), new Guid("135cc273-c797-480f-ac39-cabfde885094"), false, "SƯ TRỐN CHẠY", 0 });

            migrationBuilder.InsertData(
                table: "UserInfos",
                columns: new[] { "Id", "AccessFailedCount", "CommentId", "ConcurrencyStamp", "DoB", "Email", "EmailConfirmed", "FirstName", "Gender", "IdImageAvatar", "IsActive", "LastName", "LockoutEnabled", "LockoutEnd", "NickName", "NormalizedEmail", "NormalizedUserName", "PasswordHash", "PhoneNumber", "PhoneNumberConfirmed", "SecurityStamp", "TwoFactorEnabled", "UserName" },
                values: new object[,]
                {
                    { new Guid("135cc273-c797-480f-ac39-cabfde885094"), 0, null, "d18a1e51-9ec7-44c6-8b3e-a4fc2e452fd0", new DateTime(2001, 11, 5, 0, 0, 0, 0, DateTimeKind.Unspecified), "huynhnhat@gmail.com", true, "Nhật", true, null, true, "Huỳnh", false, null, "naruto", null, "nhathuynh", "AQAAAAEAACcQAAAAEM4B6zfXsjgKfGGGhN7E6Q/qUWqA/DsbzjWLJVy+fpyj6tnsARSttuwl/ORuOpV+CA==", "1000000002", false, "", false, "nhathuynh" },
                    { new Guid("4008d551-f305-4bc5-b143-6caa9e7e6acb"), 0, null, "1ad23ec1-709a-4e51-b608-cbf869c5c77a", new DateTime(2001, 11, 5, 0, 0, 0, 0, DateTimeKind.Unspecified), "daiphuoc@gmail.com", true, "Đại Phước", true, null, true, "Dương", false, null, "sasuke", null, "phuochuynh", "AQAAAAEAACcQAAAAEPb9XVN8zzdscGpbnCMabcXruZHf9sX2WQ4x3kHjlej02quam5H6y3gfRlV1IhOcMw==", "1000000003", false, "", false, "phuochuynh" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("e2189174-217b-4540-9563-49f24a901712"), "05f7e688-aec2-465c-957d-ca21501d7111", "Đây là Viewer", "Viewer", "Viewer" },
                    { new Guid("68f98061-01ba-4263-ab94-65a0cb908ab7"), "74ecaa85-2348-42a9-8e5b-096db5de6c8d", "Đây là manger", "Manager", "Manager" },
                    { new Guid("3f2be8b9-769d-49f5-8387-f34413daa629"), "b00f7353-824d-4207-9584-acc9caa28cd9", "Đây là Blogger", "Blogger", "Blogger" }
                });
            ...
            migrationBuilder.InsertData(
                table: "UserInfos",
                columns: new[] { "Id", "AccessFailedCount", "CommentId", "ConcurrencyStamp", "DoB", "Email", "EmailConfirmed", "FirstName", "Gender", "IdImageAvatar", "IsActive", "LastName", "LockoutEnabled", "LockoutEnd", "NickName", "NormalizedEmail", "NormalizedUserName", "PasswordHash", "PhoneNumber", "PhoneNumberConfirmed", "SecurityStamp", "TwoFactorEnabled", "UserName" },
                values: new object[] { new Guid("f2c7b584-2bec-4a0c-896b-0aae5084afe0"), 0, null, "90c50d74-09ac-49d2-ae17-74a146dae822", new DateTime(2001, 10, 4, 0, 0, 0, 0, DateTimeKind.Unspecified), "loileminh@gmail.com", true, "Lợi", true, new Guid("0619e3c9-a3ba-46ca-ba72-1136c388d003"), true, "Lê Minh", false, null, "leminhloi", null, "leminhloi", "AQAAAAEAACcQAAAAEPRRQO+IYUFgNb8EzC64htr+5oM23V+ar/auE+07fSJMApfo/2lrbsfK7TLPCRqtZw==", "1000000001", false, "", false, "leminhloi" });
